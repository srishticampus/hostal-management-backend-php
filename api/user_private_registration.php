...
if ($count > 0) {
    ...
    $sql = "INSERT INTO `user`(`name`, `email`, `address`, `contact_number`, `mess_preference`, `room_preference`, `password`,`hostal_type`,`hostal_id`) 
            VALUES ('$name', '$email', '$address', '$contact_number', '$mess_preference', '$room_preference', '$password','Private','$hostal_id')";
    $result = $con->query($sql);
