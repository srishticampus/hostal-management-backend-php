...
<div class="container-fluid page-header mb-5 p-0" style="background-image: url(img/carousel-1.jpg);">
            <div class="container-fluid page-header-inner py-5">
                <div class="container text-center pb-5">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">Attendence</h1>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h6 class="section-title text-center text-primary text-uppercase">Attendence</h6>
    ...
    <tbody>
        ...
        $sql = "SELECT * 
                FROM user 
                INNER JOIN attendence ON attendence.user_id = user.id where user.hostal_id=$hostal_id";
        ...
        <tr>
            ...
            <td><?php echo $row['user_current_date']; ?></td>
            <td><?php echo $row['user_current_time']; ?></td>
